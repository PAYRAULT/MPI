...
\item $\forall x,y \in \R, (xRy \Rightarrow yRx) \Leftrightarrow (|x| = |y| \Rightarrow |y| = |x|)$ est vrai car l'\'egalit\'e est symetrique
\item $\forall x,y,z \in \R, (xRy \wedge yRz \Rightarrow xRz) \Leftrightarrow (|x| = |y| \wedge |y| = |z| \Rightarrow |x| = |z|)$ est vrai car l'\'egalit'e est transitive
\end{itemize}
