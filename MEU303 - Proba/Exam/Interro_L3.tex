...
Il faut trouver un espace de probabilit\'e $(\Omega, F,P)$ 

\subsection*{Exercice 1.2}
La tribu d'un espace de probabilit\'e $(\Omega, F,P)$ est l'ensemble des sous-parties de $\Omega$. Comme l'ensemble $card(\Omega) \geq 3$ on a $card(P(\Omega)) \geq 3^2 = 8$.
