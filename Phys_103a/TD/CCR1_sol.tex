...
\item Le vecteur vitesse est $\vec{v} = \frac{d\vec{r}}{dt} = \dot{\rho}(t)\vec{u}_{\rho} + \rho(t)\dot{\theta}(t)\vec{u}_{\theta}$
\item Le vecteur acc\'el\'eration est $\vec{a} = \frac{d\vec{v}}{dt} = (\ddot{\rho}(t) - \rho\dot{\theta}^{2}(t))\vec{u}_{\rho} + (\rho(t)\ddot{\theta}(t) + 2\dot{\rho}(t)\dot{\theta}(t))\vec{u}_{\theta}$
\end{itemize}
