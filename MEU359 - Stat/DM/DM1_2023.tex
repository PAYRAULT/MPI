...
$$
\frac{\partial}{\partial \theta} \mathcal{L}_{\theta}(x_i,\ldots,x_n) = \frac{x_1 x_2 \ldots x_n \theta^{-n-2}.(2n\theta - (x_1+x_2+\ldots + x_n)) e^{-\frac{x_1+x_2+ \ldots + x_n}{2\theta}}} {2}
$$
...
$$
quand $\hat{\theta_n} = \frac{(x_1+x_2+\ldots + x_n)}{2n} = \frac{\mu}{2}$.
