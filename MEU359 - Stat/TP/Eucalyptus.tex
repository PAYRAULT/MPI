...
\quest{Montrer que $(n-3)\hat{\sigma}^2/\sigma^2 \thicksim \Xi (n-3)$ et $\hat{\sigma}^2$ ind\'ependant de $\hat{\beta}$}
...
\quest{Montrer que, si $\tilde{\beta}$ est sans bias, alors $MSE_\lambda(\tilde{\beta}) = VAR[\lambda^T\tilde{\beta}]$. En d\'eduire que $\bar{\beta}$ est le BLUE si et seulement si, pout tout estimateur lin\'eaire sans biais $\tilde{\beta}$, $Var(\tilde{\beta}) - Var(\bar{\beta})$ est une matrice positive.}
