...
$$\lim_{x \to (0)^{+}} \frac{x(x^x-1)}{\ln(x+1)}$$
En utilisant le developpement limit\'e $\ln(1+x)$ en 0, on a
$$\lim_{x \to (0)^{+}} \frac{x(x^x-1)}{x-\frac{x^2}{2} + \frac{x^3}{3}+\epsilon(x)}$$
$$\lim_{x \to (0)^{+}} \frac{(x^x-1)}{1-\frac{x}{2} + \frac{x^2}{3}+\epsilon(x)}$$
$$\lim_{x \to (0)^{+}} (x^x-1)$$
$$\lim_{x \to (0)^{+}} (1-1) = 0$$

Avec
$$\lim_{x \to (0)^{+}}x^x = \lim_{x \to (0)^{+}}e^{ln(x^x)} = \lim_{x \to (0)^{+}}e^{x\ln(x)} = e^0 = 1$$ 
