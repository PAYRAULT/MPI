...
Partons de $g \circ f$ est surjective, on a $\forall y \in G, \exists !x \in E, y = g \circ f(x) = g(f(x)) \textrm{  : } [1]$.\\
et $f$ est une fonction donc $\forall x_e \in E, \exists !y_f \in F, y_f = f(x_e)$.
...
Preuve par l'absurde.\\
Supposons que la fonction $g$ n'est pas injective. Donc $\exists (x_1, x_2) \in F^2, g(x_1)=g(x_2) \implies x_1 \neq x_2 \textrm{  : } [3]$.\\
