...
\item Une fonction est d\'erivable en un point $a$ si $\exists l, \lim_{x \to a}\frac{f(x)-f(a)}{x-a} = l$ ou $\exists l, \lim_{x \to a}\frac{f(a+h)-f(a)}{h}$
...
\begin{array}{l}
 ...
 \lim_{x \to \pi^{-}}\frac{(\pi-x) sin(x)}{x-\pi} \\
\end{array}
\right. 
$$
