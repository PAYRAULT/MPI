...
La premi\`ere ligne peut \^etre form\'ee en soustrayant la ligne $l_2$ et la ligne $l_3$. Donc, le rang de $(l_1, l_2, l_3)$ est \'egal au rang de $(l_2, l_3)$. Les lignes $l_2, l_3$ sont ind\'ependante (non propotionnelle). Donc, le rang de $(S)$ est $2$.\\

Trouver relation de d\'ependance entre $C_1$,$C_2$ et $C_3$:\\
$$aC_1+bC_2+cC_3 = 0$$
