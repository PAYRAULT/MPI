...
\subsubsection*{3.3}
Pour $x \in [0,\frac{\pi}{2}]$, on a $x - \frac{x^3}{6} \leq sin(x)$ si $x - \frac{x^3}{6} \leq x - \int_0^x{\frac{(x-t)^2}{2}\cos(t)dt}$, donc $\frac{x^3}{6} > \int_0^x{\frac{(x-t)^2}{2}\cos(t)dt}$ ou $\frac{x^3}{3} > \int_0^x{(x-t)^2\cos(t)dt}$.

$$\int_0^{\frac{\pi}{2}}{(x-t)^2\cos(t)dt} = \int_0^{\frac{\pi}{2}}{(x^2-2xt+t^2)\cos(t)dt} = x^2\int_0^{\frac{\pi}{2}}{\cos(t)}dt -2x\int_0^{\frac{\pi}{2}}{t\cos(t)dt} + \int_0^{\frac{\pi}{2}}{t^2\cos(t)dt}$$
