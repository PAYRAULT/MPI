...
\begin{array}{l l}
0 &  t \in [0,8] \\
1.1*t - 0.22/2*t^2 + 0.01/3*t^3 -3.466 &  t \in ]8,11] \\
-0.1*\tau-0.24 &  t \in ]11,15],\, \tau = t-11 \\
\end{array}
\right. 
$$
...
\addplot [
    ...
    {1.1*x-0.11*x^2+(0.01/3)*x^3-3.46666};
\addplot [
    domain=11:15, 
    samples=100,
    color=blue,
...
\addplot [
    ...
    ({-0.05*x^2 + 2.25*x},{1.1*x-0.11*x^2+(0.01/3)*x^3-3.46666});
\addplot [
    domain=11:15, 
    samples=100,
    color=blue,
    ]
    ({-0.05*x^2 + 2.25*x},{-0.1*(x-11)-0.24});
